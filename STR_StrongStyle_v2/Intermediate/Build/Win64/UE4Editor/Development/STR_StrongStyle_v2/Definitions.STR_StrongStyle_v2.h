...
#define ORIGINAL_FILE_NAME "UE4Editor-STR_StrongStyle_v2.dll"
#define UE_IS_ENGINE_MODULE 0
#define UE_BUILD_DEVELOPMENT_WITH_DEBUGGAME 0
#define UE_PROJECT_NAME STR_StrongStyle_v2
...
#define STR_STRONGSTYLE_V2_API DLLEXPORT
